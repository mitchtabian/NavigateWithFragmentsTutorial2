...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Front_Page_Fragment front_page_fragment = new Front_Page_Fragment();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.listview_page) {

            //--------------------set the listview fragment-------------------
            ListView_Fragment listView_fragment = new ListView_Fragment();
            android.support.v4.app.FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container,listView_fragment);
            fragmentTransaction.commit();
